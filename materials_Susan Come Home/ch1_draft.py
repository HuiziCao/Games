...
class Sheep(Move):
    ...
    def invite_for_journey(self):
        self.display_text(f"{self.player_name}, 和我一起回我的故乡吧。我需要你的帮助，我也想带你参观我的家乡。")
        self.display_text("在走之前，你来帮我打扮一下吧。")
        self.display_text("来吧，到我的衣帽间来。(enter confirm after choosing)")
    ...
    def choose_clothes(self, clothes_options):
        ...
        while True:
            try:
                ...
                # 检查是否输入了确认
                if input("Type 'confirm' to confirm the choice, or press Enter to continue: ").lower() == "confirm":
                    for c in circles:  # 移除所有衣服选项的圆形
                        c.undraw()
                    return  # 退出函数
        ...
        while True:
            try:
                ...
                for circle in circles:  # 移除所有衣服选项的圆形
                        circle.undraw()
                        break  # 退出函数
    ...
    def choose_clothes(self, clothes_options):
        ...
        while True:
            ...
            # 检查用户是否输入了确认
            user_input = input("Type 'confirm' to confirm the choice, or press Enter to continue: ").lower()
